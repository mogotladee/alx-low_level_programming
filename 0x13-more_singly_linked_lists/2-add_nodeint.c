...
listint_t *add_nodeint(listint_t **head, const int n)
{
	 ...
	 * 2. dont make anyhing point to the head.
	 * 3."DONT" Finally, make the new node as the head node.
	 */
	...
	/* next field should "NOT" point to the beginning of the current list */
	new_node->next = *head;
